...
@Component({
  selector: 'app-home',
  standalone: true,
  imports: [FuseCardComponent, MatButtonToggleModule, CommonModule, CdkScrollable, MatFormFieldModule, MatSelectModule, MatOptionModule, NgFor, MatIconModule, MatInputModule, MatSlideToggleModule, NgIf, NgClass, MatTooltipModule, MatProgressBarModule, MatButtonModule, RouterLink, FuseFindByKeyPipe, PercentPipe, I18nPluralPipe, MatButtonModule, RouterLink, MatIconModule, NgFor, MatExpansionModule],
