            ...
            },
            {
                ...
                children: [
                    ...
                    },*/
                    {
                        ...
                        type : 'basic',
                        icon : 'heroicons_outline:eye',
                        link : '/candidates/view/:id',
                    },
                ]
            },
            {
                id  : 'dashboards.establishments',
                title: 'Establishments',
                type:  'collapsable',
                icon:  'heroicons_outline:building-library',
                link:  '/dashboards/establishments',
                children: [
                    {
                        ...
                        type : 'basic',
                        icon : 'heroicons_outline:user-plus',
                        link : '/establishments/add',
                    },
                    /*{
                        id   : 'establishment.edit',
                        title: 'Edit Establishment',
                        type : 'basic',
                        icon : 'heroicons_outline:user-plus',
                        link : '/establishments/edit/:id',
                    },*/
                    {
                        id   : 'establishment.view',
                        title: 'View Establishment',
                        type : 'basic',
                        icon : 'heroicons_outline:eye',
                        link : '/establishments/view/:id',
                    },
                ]
            },
            {
                id  : 'dashboards.parents',
                title: 'Parents',
                type:  'collapsable',
                icon:  'heroicons_outline:users',
                link:  '/dashboards/parents',
                children: [
                    {
                        id   : 'parent.add',
                        title: 'Add Parent',
