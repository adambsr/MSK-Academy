...
@Component({
    selector     : 'clayoutHome',
    templateUrl  : './copylayoutHome.component.html',
    styleUrls    : ['./copylayoutHome.component.scss'],
    encapsulation: ViewEncapsulation.None,
    standalone   : true,
    imports      : [NgIf,  ModernLayoutHomeComponent,ModernLayoutComponent, SettingsComponent, EmptyLayoutComponent, MaterialLayoutComponent, ClassicLayoutComponent ],
})
export class CLayoutHomeComponent implements OnInit, OnDestroy
{
    config: FuseConfig;
    layout: string;
    scheme: 'dark' | 'light';
